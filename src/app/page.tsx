...
export default function Home() {
  ...
  return (
    <>
      {/* SECTION 1 — HERO */}
      <section className="relative min-h-[92vh] sm:min-h-screen flex items-end justify-start overflow-hidden bg-[#0D1B2A]">
        ...
        <div className="relative z-10 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 pb-16 sm:pb-24 pt-32">
          <div className="max-w-2xl space-y-6">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white leading-tight tracking-tight">
              Hunian Berkualitas di Bandung & Sekitarnya
            </h1>
            <p className="text-base sm:text-lg text-white/85 max-w-xl leading-relaxed">
              Wujudkan impian memiliki rumah dengan desain arsitektur modern, lingkungan asri, dan aksesibilitas terbaik untuk keluarga Anda.
            </p>
            <div className="flex flex-wrap items-center gap-4 pt-2">
              <Link
                href="/produk"
                className="inline-flex items-center justify-center px-7 py-3 rounded-lg bg-[#0B5EAA] text-white font-semibold text-sm sm:text-base hover:bg-[#0A4F91] transition-all shadow-lg active:scale-95"
              >
                Lihat Proyek
              </Link>
              <Link
                href="/kontak"
                className="inline-flex items-center justify-center px-7 py-3 rounded-lg border-1.5 border-white text-white font-semibold text-sm sm:text-base hover:bg-white/10 backdrop-blur-xs transition-all active:scale-95"
              >
                Hubungi Kami
              </Link>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-lg aspect-[4/3]">
                <img
                  ...
                  alt="Interior Ruang Tamu Modern"
                  className="w-full h-full object-cover"
                />
              </div>

              {/* Overlapping Badge */}
              <div className="absolute -bottom-5 left-5 sm:left-8 bg-[#0B5EAA] text-white rounded-xl p-4 sm:p-5 shadow-xl flex items-center gap-3">
                <span className="text-2xl sm:text-3xl font-bold tracking-tight">14+</span>
                <span className="text-xs sm:text-sm font-medium leading-tight max-w-[110px]">
                  Tahun Berpengalaman
                </span>
              </div>
            </div>
            ...
            <div className="space-y-5 pt-4 lg:pt-0">
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#111827] leading-tight">
                Membangun Masa Depan Sejak 2010
              </h2>
              <p className="text-sm sm:text-base text-[#6B7280] leading-relaxed">
                Marga Tirta Kencana telah menjadi mitra terpercaya dalam menghadirkan hunian yang tidak hanya sekadar tempat tinggal, tetapi sebuah investasi masa depan. Dengan dedikasi tinggi pada kualitas konstruksi dan estetika modern, kami telah sukses mengembangkan berbagai kawasan residensial strategis di wilayah Bandung dan sekitarnya.
              </p>
              <div className="pt-2">
                <Link
                  href="/tentang"
                  className="inline-flex items-center gap-2 text-[#0B5EAA] font-semibold text-sm hover:underline group"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            {featuredProjects.map((project) => (
              <Link
                key={project.id}
                href={project.href}
                className="group bg-white rounded-xl overflow-hidden shadow-[0_1px_4px_rgba(0,0,0,0.08)] hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
              >
                {/* Project Image */}
                ...
                <div className="p-5 space-y-3">
                  <h3 className="text-lg font-semibold text-[#111827] group-hover:text-[#0B5EAA] transition-colors">
                    {project.title}
                  </h3>
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-gray-100">
                    <span className="text-base font-semibold text-[#0B5EAA]">
                      {project.price}
                    </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            {facilities.map((fac, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="bg-white border border-[#E5E7EB] rounded-xl p-7 shadow-xs hover:border-[#0B5EAA]/40 hover:shadow-md transition-all space-y-4"
                >
