...
export default function TCI2OverviewPage() {
  ...
  const unitGallery = [
    { label: "Ruang Tamu", src: "/images/proyek/tci/tci-2/tci2-living.webp", alt: "Ruang tamu unit TCI 2" },
    { label: "Kamar Tidur", src: "/images/proyek/tci/tci-2/tci2-bed.webp", alt: "Kamar tidur unit TCI 2" },
    { label: "Dapur", src: "/images/proyek/tci/tci-2/tci2-kitchen.webp", alt: "Dapur unit TCI 2" },
  ];
      ...
      <section className="relative min-h-[60vh] flex items-end justify-start bg-[#0D1B2A] overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 pb-16 pt-28">
          <div className="max-w-2xl space-y-4">
            ...
            <p className="text-sm sm:text-base text-[rgb(246,247,248)] line-clamp-2 leading-relaxed flex-grow">Pengembangan kawasan hunian modern yang menawarkan harga yang terjangkau.</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-20 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-xl mb-10 space-y-2">
            ...
            <p className="text-sm text-[#6B7280]">Intip setiap sudut hunian di Taman Cibaduyut Indah 2.</p>
          </div>
