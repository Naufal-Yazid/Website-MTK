  ...
  const floorPlanSteps = [
    {
      ...
      description:
        "Ruang tamu dan ruang makan dirancang menyatu untuk menciptakan suasana yang lebih lapang dan nyaman.",
    },
    {
      num: "02",
      title: "Dua Kamar Tidur",
      description:
        "Dua kamar tidur dengan penataan ruang yang efisien memberikan privasi untuk seluruh anggota keluarga.",
    },
    {
      num: "03",
      title: "Sirkulasi Udara Optimal",
      description:
        "Penempatan pintu dan jendela yang strategis membantu pencahayaan serta pertukaran udara alami.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-xl mx-auto mb-12 space-y-2">
            ...
            <p className="text-sm text-[#6B7280] leading-relaxed">
              Visualisasi tata ruang Tipe 50 yang dirancang untuk memberikan
              kenyamanan dan pemanfaatan ruang secara optimal.
            </p>
          </div>
