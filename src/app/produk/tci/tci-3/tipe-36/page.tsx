...
export default function TCI3Tipe36Page() {
  const specs = [
    { icon: Ruler, label: "LUAS TANAH", value: "72 m²" },
    { icon: HomeIcon, label: "LUAS BANGUNAN", value: "36 m²" },
  ...
  const floorPlanSteps = [
    {
      ...
      description:
        "Ruang tamu dan ruang makan yang menyatu memberikan kesan luas pada interior rumah.",
    },
    {
      num: "02",
      title: "Dual Bedroom",
      description:
        "Dua kamar tidur yang terpisah memberikan privasi maksimal untuk orang tua dan anak.",
    },
    {
      num: "03",
      title: "Sirkulasi Udara Optimal",
      description:
        "Penempatan jendela strategis di bagian depan dan belakang menjamin pertukaran udara yang baik.",
    },
  ];
        ...
        <div className="relative z-10 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 pb-16 pt-28">
          <div className="max-w-2xl space-y-4">
            ...
            <p className="text-sm sm:text-base text-white/80 max-w-xl leading-relaxed">
              Hunian modern minimalis yang dirancang dengan efisiensi ruang
              maksimal dan estetika kontemporer untuk kenyamanan keluarga Anda.
            </p>
            ...
            <div className="lg:col-span-7 space-y-6">
              <div>
                ...
                <p className="text-sm text-[#6B7280] mt-2">
                  Tipe 50 di TCI 3 dirancang untuk memberikan kenyamanan
                  maksimal dengan pemanfaatan lahan yang cerdas dan material
                  bangunan kelas satu.
                </p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-xl mx-auto mb-12 space-y-2">
            ...
            <p className="text-sm text-[#6B7280]">
              Visualisasi tata ruang yang efisien, mengoptimalkan setiap meter
              persegi untuk mendukung aktivitas harian Anda.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center max-w-5xl mx-auto">
            ...
            <div className="lg:col-span-6 bg-white border border-[#E5E7EB] rounded-2xl p-6 shadow-sm aspect-square flex items-center justify-center overflow-hidden">
              <img
                src="/floor-plan/36-72.webp"
                alt="Denah rumah TCI 3 Tipe 36"
